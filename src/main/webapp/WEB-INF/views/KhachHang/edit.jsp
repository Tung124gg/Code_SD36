        ...
        <frm:form
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <frm:input cssStyle="width: 500px; height: 35px;border-radius: 5px 5px 5px" path="ghiChu" type=""
                               value=""/>
            ...
            <button type="submit"
                    ...
                    style="margin-left: 600px; margin-bottom: 190px" class="btn btn-primary">Update
            </button>
            <label>${message}</label>
        </frm:form>
    </div>
